  ...
  const NAV_GROUPS = [
    {
      ...
      items: [
        ...
        { icon: '📦', label: t('navigation.purchaseOrders'), href: '/purchase' },
        { icon: "🏭", label: t('navigation.suppliers'),  href: "/suppliers"},
        { icon: '📧', label: t('navigation.purchaseinvoices'),    href: '/purchaseinvoice' },
      ],
    },
    {
