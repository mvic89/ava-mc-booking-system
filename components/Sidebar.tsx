...
export default function Sidebar() {
  ...
  const ALL_NAV_GROUPS = [
    ...
    // ── Dealer roles ─────────────────────────────────────────────────────────
    {
      ...
      items: [
        { icon: '📊', label: t('navigation.dashboard'),        href: '/dashboard',             roles: ['admin', 'sales', 'service', 'sales_manager', 'accountant', 'technician'] },
    ...
    },
    {
      ...
      items: [
        { icon: '💰', label: t('navigation.pipeline'),          href: '/sales/leads',        roles: ['admin', 'sales', 'sales_manager'] },
        { icon: '🛒', label: t('navigation.counterSale'),       href: '/sales/counter-sale', roles: ['admin', 'sales', 'sales_manager', 'service', 'technician'] },
    ...
    {
      labelKey: 'Service',
      label: t('navigation.groups.service'),
      items: [
        { icon: '🛠️', label: t('navigation.service'),             href: '/service',              roles: ['admin', 'service', 'technician'] },
        { icon: '📋', label: t('navigation.serviceBookings'),   href: '/service/bookings',     roles: ['admin', 'service', 'technician'] },
        { icon: '🗂️', label: t('navigation.serviceOrders'),     href: '/service/orders',       roles: ['admin', 'service', 'technician'] },
        { icon: '📅', label: t('navigation.scheduling'),        href: '/service/scheduling',   roles: ['admin', 'service', 'technician'] },
        { icon: '🔔', label: t('navigation.serviceReminders'),  href: '/service/reminders',    roles: ['admin', 'service'] },
      ],
    },
    {
      labelKey: 'Admin',
      ...
      items: [
        ...
        { icon: '🎯', label: t('navigation.targets'),      href: '/settings/targets',  roles: ['admin', 'sales_manager'] },
