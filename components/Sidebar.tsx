...
export default function Sidebar() {
  ...
  const ALL_NAV_GROUPS = [
    ...
    },
    {
      ...
      items: [
        { icon: '💰', label: t('navigation.pipeline'),     href: '/sales/leads',  roles: ['admin', 'sales', 'service', 'sales_manager'] },
        { icon: '📅', label: t('navigation.calendar'),     href: '/calendar',     roles: ['admin', 'sales', 'service', 'sales_manager', 'technician'] },
        { icon: '👥', label: t('navigation.customers'),    href: '/customers',    roles: ['admin', 'sales', 'service', 'sales_manager', 'accountant'] },
        { icon: '📧', label: t('navigation.invoices'),     href: '/invoices',     roles: ['admin', 'sales', 'service', 'sales_manager', 'accountant'] },
        { icon: '❌', label: t('navigation.cancellations'),href: '/cancellations',roles: ['admin', 'sales', 'sales_manager'] },
        { icon: '🛡️', label: t('navigation.warranties'),   href: '/warranties',   roles: ['admin', 'sales', 'service', 'sales_manager'] },
        { icon: '🔧', label: t('navigation.service'),      href: '/service',      roles: ['admin', 'service', 'technician'] },
      ],
    },
    {
      labelKey: 'Admin',
