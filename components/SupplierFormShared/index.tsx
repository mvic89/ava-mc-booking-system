...
export function TextAreaField({
    ...
    return (
        <div className="col-span-2">
            <label className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold mb-1.5 block">{label}</label>
    ...
    return (
        <div className="grid grid-cols-2 gap-x-5 gap-y-4">
            ...
            <Field label="Free Shipping Threshold (SEK)" value={form.freeShippingThreshold}
                ...
                placeholder="e.g. 500 — leave blank if not applicable"
                type="number" span />
        </div>
    )
}
