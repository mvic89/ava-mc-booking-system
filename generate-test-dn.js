// Run: node generate-test-dn.js
// Generates test-dn-vartex-single.pdf — same as the Vartex delivery note but with only one item.
...
field('Ordernummer',     '002E39206',       col1L, col1V, 44)
field('Följesedelsdatum','2026-03-04',       col2L, col2V, 44)
field('Kundnummer',      '3238600',          col1L, col1V, 52)
field('Leveransdatum',   '2026-03-03',       col2L, col2V, 52)
...
// ── Single item row (501190Z005-A6 removed) ───────────────────────────────────
...
// ── Write file ────────────────────────────────────────────────────────────────
const outPath = 'test-dn-vartex-single.pdf'
