...
import NewLeadPage from './sales/leads/new/page';
...
export default function Home() {
  ...
  return (
    <div className="max-w-[900px] mx-auto px-6 py-10">
      {/* Header */}
      <div className="mb-10">
        <h1 className="text-[28px] font-extrabold text-[#FF6B2C]">
          MOTOOS <span className="text-xs text-slate-400 font-normal">v3.0</span>
        </h1>
