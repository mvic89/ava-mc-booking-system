    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Track and manage invoices received from suppliers</p>
        </div>
        <button
          onClick={openCreate}
          className="flex items-center gap-2 bg-[#FF6B2C] hover:bg-[#e55a1f] text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-colors shadow-sm"
        >
          <span className="text-base leading-none">+</span> Create New Invoice
        </button>
      </div>
