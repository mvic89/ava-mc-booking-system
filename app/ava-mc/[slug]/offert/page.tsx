  ...
  return (
    <div className="max-w-lg mx-auto p-6 md:p-8 pb-24">
      ...
      <div className="mt-5 mb-6">
        ...
        <h1 className="text-2xl font-bold text-white mt-1">Begär Offert</h1>
      </div>
      ...
      <div className="flex items-center gap-4 border border-neutral-700 rounded-xl p-3 bg-neutral-800/40 mb-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white font-semibold text-sm truncate">{bike.model}</p>
      ...
      {/* Form */}
      <OfferForm bikeName={`${bike.brand} ${bike.model}`} bikeSlug={bike.slug} />
    </div>
  );
}
